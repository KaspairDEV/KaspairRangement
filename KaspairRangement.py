            ...
            for fichier in fichiers:
                ...
                if new_path.endswith("pdf"):
                    try:
                        ...
                        pass
                elif new_path.endswith("txt") or new_path.endswith(".odt") or new_path.endswith(
                        "docx") or new_path.endswith("doc"):
                    try:
                        shutil.move(new_path, textes)
                    except:
                        pass
                elif new_path.endswith("jpeg") or new_path.endswith("jpg") or new_path.endswith(
                        "png") or new_path.endswith("psd"):
                    try:
                        shutil.move(new_path, images)
                    except:
                        pass
                elif new_path.endswith("mp4") or new_path.endswith("avi") or new_path.endswith(
                        "mov") or new_path.endswith("flv") or new_path.endswith("mkv") or new_path.endswith("wmv"):
                    try:
